...
| [**Road Risk Model**](https://github.com/IOSHED/Iosh__ModelDangerRoad) | 🚗 Модель оценки вероятности ДТП на основе дорожных условий, характеристик водителя и внешних факторов. Использует линейные и ML-подходы. | `Python`, `Pandas`, `PyTourch`, `Matplotlib` |
